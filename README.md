...
| Hari   | Tugas                         | Output                           |
|--------|-------------------------------|----------------------------------|
| Senin  | Riset kebutuhan               | Report riset                     |
| Selasa | Pembuatan TOR                 | Dokumen TOR                      |
|        | Asset campaign               | Flyer                            |
|        | Pembuatan pendaftaran         | Google Form                      |
| Rabu   | Promosi coming soon           | bukti penyebaran di sosmed       |
|        | Persiapan narasumber         | Pemateri                         |
| Kamis  | Promosi pendaftaran          | Penyebaran di sosmed             |
| Jumat  | Gladi                        | Report gladi                     |
| Sabtu  | Acara (Hari H)               | Pelaksanaan kegiatan             |
|        | Pembuatan sertifikat         | Sertifikat                       |
